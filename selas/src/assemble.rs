        ...
        for pi in &pending {
            match resolve_labels(
                ...
                None => {
                    ...
                    // Local labels (generated by selcc's branch
                    // resolution) should have been resolved above by
                    // resolve_labels. If they weren't, something went
                    // wrong in the first pass, but emitting them as
                    // linker relocations would fail because the linker
                    // doesn't know about .L_ symbols. Skip them.
